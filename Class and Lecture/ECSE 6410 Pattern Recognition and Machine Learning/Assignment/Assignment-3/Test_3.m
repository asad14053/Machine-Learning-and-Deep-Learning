...
% Show pre-processing results- removing the noise and scaling manually
exTrainImage = readimage(trainingSet,1);
processedImage = imbinarize(im2gray(exTrainImage));
